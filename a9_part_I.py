...
# One or more alphanumeric characters, followed by
# One or more white spaces, followed by
# One or more digits, followed by a comma, follwed by
# One or more white spaces, followed by
# Four digits
pat = re.compile(r"(?P<Month>\w+)\s+(?P<Date>\d+),\s+(?P<Year>\d{4})", re.IGNORECASE)
...
# STREET
# One or more patterns of:
#   One or more letters/numbers, followed by
#   One or more spaces
# Followed by one or more patterns of:
#   One or more white spaces, followed by
...
# STATE
# Two alphabetical characters, followed by 
# One or more white spaces, followed by
...
#print(f"Street Number: {address_matches.group('Number')}")
#print(f"City: {address_matches.group('City')}")
...
# IGNORE:
# One or more patterns of:
#   One or more alphanumerical characters, followed by
#   One or more white spaces
